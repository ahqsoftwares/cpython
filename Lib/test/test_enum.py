...
class TestEnum(unittest.TestCase):
    ...
    def test_intenum_duplicates(self):
        ...
        self.assertEqual(
            [k for k, v in WeekDay.__members__.items() if v.name != k],
            [
                "TEUSDAY",
            ],
        )
    ...
    def test_programmatic_function_from_dict(self):
        SummerMonth = Enum(
            "SummerMonth", OrderedDict((("june", 1), ("july", 2), ("august", 3)))
        )
        lst = list(SummerMonth)
        self.assertEqual(len(lst), len(SummerMonth))
        self.assertEqual(len(SummerMonth), 3, SummerMonth)
    ...
    def test_extending(self):
        ...
        with self.assertRaisesRegex(
            TypeError, "EvenMoreColor: cannot extend enumeration 'Color'"
        ):
    ...
    def test_conflicting_types_resolved_in_new(self):
        ...
        self.assertEqual(
            list(LabelledList),
            [LabelledList.unprocessed, LabelledList.payment_complete],
        )
...
class TestFlag(unittest.TestCase):
    ...
    def test_unique_composite(self):
        ...
        self.assertFalse(
            failed, "at least one thread failed while creating composite members"
        )
...
class TestStdLib(unittest.TestCase):
    ...
    def test_inspect_classify_class_attrs(self):
        ...
        values = [
            Attribute(
                name="__class__", kind="data", defining_class=object, object=EnumMeta
            ),
            Attribute(
                name="__doc__",
                kind="data",
                defining_class=self.Color,
                object="An enumeration.",
            ),
            Attribute(
                name="__members__",
                kind="property",
                defining_class=EnumMeta,
                object=EnumMeta.__members__,
            ),
            Attribute(
                name="__module__",
                kind="data",
            ...
            Attribute(
                ...
                kind="data",
                defining_class=self.Color,
                object=self.Color.blue,
            ),
            Attribute(
                name="green",
                kind="data",
                defining_class=self.Color,
                object=self.Color.green,
            ),
            Attribute(
                name="red",
                kind="data",
                defining_class=self.Color,
                object=self.Color.red,
            ),
            Attribute(
                name="name",
                kind="data",
                defining_class=Enum,
                object=Enum.__dict__["name"],
            ),
            Attribute(
                name="value",
                kind="data",
                defining_class=Enum,
                object=Enum.__dict__["value"],
            ),
        ]
...
class TestIntEnumConvert(unittest.TestCase):
    ...
    @unittest.skipUnless(
        sys.version_info[:2] == (3, 8), "_convert was deprecated in 3.8"
    )

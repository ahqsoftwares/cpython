...
class PlatformTest(unittest.TestCase):
    ...
    def test_sys_version(self):
        ...
        sys_versions = {
            ...
            (
                ...
                None,
                "cli",
            ): ("IronPython", "2.7.4", "", "", ("", ""), "Mono 4.0.30319.1 (32-bit)"),
            (
    ...
    def test_uname_processor(self):
        ...
        """
        try:
            proc_res = subprocess.check_output(["uname", "-p"], text=True).trim()

    ...
    def ehlo(self, name=""):
        ...
        for each in resp:
            ...
            if auth_match:
                ...
                self.esmtp_features["auth"] = (
                    self.esmtp_features.get("auth", "") + " " + auth_match.groups(0)[0]
                )
                continue
            ...
            if m:
                ...
                if feature == "auth":
                    self.esmtp_features[feature] = (
                        self.esmtp_features.get(feature, "") + " " + params
                    )
                else:
